...
Let's define the vectors of success probabilities on GSM8K and GSM-Symbolic as 

$$
p^{8K}_\text{subset}=[p^{8K}_1,\dots,p^{8K}_7]
$$
...
$$
\begin{aligned}
t\_i(v^{8K}\_i) \quad \text{and} \quad t\_i(v^{Symb}\_{i,j}),
\end{aligned}
$$
respectively.[^6]
...
\end{aligned}
$$
Similarly, each $\hat{p}_{m,j}^{Symb}, 1 \le j \le 50$ is an observation of 
$$
\begin{aligned}
